      ...
      <div className="max-w-7xl mx-auto w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div>
            ...
            <h1 className="text-5xl md:text-8xl font-extrabold text-black mb-10 leading-tight">
            ...
            <div className="space-y-8">
              <a
                ...
                className="flex items-center space-x-4 md:space-x-6 group border-b border-gray-100 pb-8 hover:border-black transition-colors"
              >
                <div className="w-12 h-12 md:w-16 md:h-16 bg-gray-50 rounded-2xl flex items-center justify-center text-black group-hover:bg-black group-hover:text-white transition-all">
                  <Mail size={24} />
                </div>
                <div>
              ...
              >
                ...
                <div>
                  ...
                  <span className="text-lg md:text-2xl font-bold">LinkedIn</span>
                </div>
                <ArrowRight className="ml-auto opacity-0 group-hover:opacity-100 group-hover:translate-x-2 transition-all" />
              </a>
            </div>
          ...
          <motion.div
            ...
            className="bg-black text-white p-8 md:p-16 rounded-3xl md:rounded-[3rem] shadow-2xl"
          >
