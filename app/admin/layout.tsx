    ...
    <div className="admin-layout" suppressHydrationWarning={true}>
      ...
      <aside className="admin-sidebar">
        <div className="admin-sidebar-brand">
          <div className="admin-sidebar-brand-icon" style={{ backgroundColor: 'transparent', padding: 0 }}>
            <img src="/work/icon.png" alt="Catalyr" style={{ width: '100%', height: '100%', objectFit: 'contain' }} />
          </div>
          <span className="admin-sidebar-brand-text">Catalyr</span>
        ...
        <nav className="admin-sidebar-nav">
          ...
          <a href="/admin/sitemap" className="admin-nav-link">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <a href="/admin/seo" className="admin-nav-link">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <a href="/admin/aeo" className="admin-nav-link">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <path d="M12 2a10 10 0 1 0 10 10H12V2Z" />
              <path d="M22 12A10 10 0 0 0 12 2v10l8.5 5" />
            </svg>
            AEO Manager
          </a>

          <a href="/admin/gtm" className="admin-nav-link">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
